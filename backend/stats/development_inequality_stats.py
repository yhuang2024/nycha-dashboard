...
df["service_connections"] = pd.to_numeric(
    df["service_connections"], errors="coerce"
)
...
# remove extreme small-denominator distortions
...
# -----------------------------
# VARIANCE ANALYSIS (BOROUGH EFFECT)
# -----------------------------
# merge borough back in (mode borough per development)
borough_map = (
...
# -----------------------------
# how much of services are in top X%
...
# -----------------------------
print("\n=== DATA QUALITY ===")
print("Total developments:", len(dev_stats))
